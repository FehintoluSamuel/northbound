        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FurthestSlideIndex = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutlineContent = table.Column<string>(type: "text", nullable: false),
                    MarketSymbol = table.Column<string>(type: "text", nullable: true),
                    ReleaseDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ImageBytes = table.Column<byte[]>(type: "bytea", nullable: true),
                    IsLiveDay = table.Column<bool>(type: "boolean", nullable: false),
                    SlideFilePath = table.Column<string>(type: "text", nullable: true),
                    HandoutFilePath = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TopicBankItemId = table.Column<int>(type: "integer", nullable: false),
